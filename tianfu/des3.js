...
const key = '8a9ba60ef59940e9823ea66feffa7d9f';

function encrypt(input) {
    return base64encode(des(key, utf16to8(input), 1, 1, des3iv, 1))
}
...
function decrypt(input) {
    return Handle(utf8to16(des(key, base64decode(input), 0, 1, des3iv, 0)))
}

// const des3 = {encrypt, decrypt}
